            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            findPosts = _a.sent();
                            return [2 /*return*/, findPosts];
                    }
                });
            });
        };
        PostService_1.prototype.create = function (postData) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.post.create({ data: postData })];
                        case 1:
                            data = _a.sent();
